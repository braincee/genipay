    ...
    <div>
        <div className='flex flex-row justify-between'>
         <div>
            ...
            <div><p className='text-[#0188A5] text-[25px] tracking-tighter mb-[24px] let_get'>Create a 6-digit Passcode</p></div>
            <div className='mb-[20px] md:w-[90%] md:text-center'><p>The Passcode as it will be required for critical confirmations and logging into the app.</p></div>
                <form>
                    <div className='flex gap-1 md:gap-4'>
                      <input
                       type="number"
                       name="number"
                      className='border text-[#2c2c2e] w-[10px] h-[56px] rounded-[8px] p-[24px] md:w-[11px]'
                     />
                     <input
                       type="number"
                       name="number"
                     ...
                     <button type="submit" className='h-[40px] w-[327px] bg-[#E0F7FE] rounded-lg mt-[38px] md:w-[385px]'>CONFIRM</button>
                </form>
             </div>
            </div>
            <div>
