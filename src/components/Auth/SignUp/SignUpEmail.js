    ...
    <div>
        <div className='flex flex-row justify-between'>
         <div>
            ...
            <div className='text-[#0188A5] text-[30px] tracking-tighter mb-[20px] let_get'><p>Lets's get started</p></div>
                <form>
                    <div className='flex flex-col gap-2'>
                      ...
                      className='border text-[#2c2c2e] w-[327px] h-[56px] rounded-[8px] p-[20px]'
                     />
                       <input
                       type="text"
                       name="password"
                ...
                <div className='text-[10px] tracking-tighter mt-3'><p>Already have an account?<Link to="/"><span className='text-[#0188A5]'>Login instead</span></Link></p></div>
